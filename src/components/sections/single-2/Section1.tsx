    ...
    <>
      ...
      <section className="sec-1-single-2 pb-70 overflow-hidden">
        <div className="position-relative block-banner">
          <Image className="banner start-50 position-lg-absolute d-lg-block d-none" src="/assets/imgs/page/img-108.png" alt="magzin" width={944} height={600} />
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-6 d-block d-lg-none pb-4">
                <Image className="banner cover-image" src="/assets/imgs/page/img-108.png" alt="magzin" width={944} height={600} />
              </div>
            </div>
          </div>
        </div>
        <div className="container">
          <div className="row">
            <div className="col-lg-9 col-md-10 offset-lg-1 offset-md-1">
              <ContentSingle image="/assets/imgs/page/img-114.png" />
            </div>
          </div>
        </div>
      </section>
