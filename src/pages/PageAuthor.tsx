                        ...
                        <div className="col-lg-6 col-md-8 mx-auto">
                            <div className="card">
                                <div className="card-img mb-4 text-center">
                                    <Image className="rounded-circle avatar-154" src="/assets/imgs/template/author/author-19.png" alt="magzin" width={200} height={300} />
                                </div>
                                <div className="card-body text-center">
                                    <h3 className="mb-3">Barbara Cartland</h3>
                                    <p className="mb-0 fs-7">
                                        You should write because you love the shape of stories and sentences and the <br className="d-none d-lg-block" />
                                        creation of different words on a page.
                                    </p>
                                    <div className="d-inline-flex group-social-icons bg-transparent mt-2" id="toppagination">
